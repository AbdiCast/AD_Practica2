...
var request = require('request'); // "Request" library (recomendable usar axios en lugar de request)
var cors = require('cors');
var querystring = require('querystring'); 
var cookieParser = require('cookie-parser');

var client_id = '80955c9f159d4b62b595949bfb496f1b'; // Your client id
var client_secret = '5b4f9296ab9f485eba8ecbbd050612d2'; // Your secret
var redirect_uri = 'http://localhost:8888/uno'; // Your redirect uri
...
app.get('/login', function(req, res) { 
  ...
  res.redirect('https://accounts.spotify.com/authorize?' +        ///autorizar
